...
CREATE TABLE IF NOT EXISTS film_review_likes (
    review_id integer REFERENCES film_reviews (review_id) ON DELETE CASCADE,
    user_id integer REFERENCES users (user_id) ON DELETE CASCADE,
    isLike boolean
);
...
ALTER TABLE film_review_likes ADD FOREIGN KEY (review_id) REFERENCES film_reviews (review_id);

ALTER TABLE film_review_likes ADD FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ALTER TABLE film_reviews ADD CONSTRAINT IF NOT EXISTS unique_review_and_user_id UNIQUE (review_id, user_id);
